...
import {fetchFeatures } from '../../../services/store/actions/issueActions';
...
class Features extends React.Component{
    ...
    componentDidMount(){
        var wow = new WOW.WOW();
        wow.init();
        this.props.fetchFeatures(this.props.authres.token);
    }
    render(){
                        ...
                        <Table.Body>
                            {features.map(issue => (
                                <Table.Row key={issue.id} className="issuerow row">
                                    ...
                                    <Table.Cell><Label className="type tiny"><Icon name="bell"/></Label></Table.Cell>
                                </Table.Row>
                            ))}
                        </Table.Body>
                    </Table>
